Центруати заданий рядок з заданим заповнювачем\hypertarget{md_Markdown_remakelab63_autotoc_md18}{}\doxysubsubsection{1. функція dogit\+To\+String}\label{md_Markdown_remakelab63_autotoc_md18}
\begin{DoxyVerb}void digitToString(int VALUE)
{
...
\end{DoxyVerb}
 \hypertarget{md_Markdown_remakelab63_autotoc_md19}{}\doxysubsubsection{2. main функція}\label{md_Markdown_remakelab63_autotoc_md19}
...
\end{DoxyVerb}
 \hypertarget{md_Markdown_remakelab63_autotoc_md20}{}\doxysubsubsection{3. блок-\/схема}\label{md_Markdown_remakelab63_autotoc_md20}
